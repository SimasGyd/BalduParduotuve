...
public class DataImport {
    public void addPrekes() {
        ...
        roundChairSand.setPreke(fluffyChair);
        roundChairParduotuve.setPreke(fluffyChair);
        roundChairParduota.setPreke(fluffyChair);
        ...
        session.persist(fluffyChairParduota);
        session.persist(fluffyChairSand);
        session.persist(fluffyChairParduotuve);
